# compile this to exe as offtimeSvc.exe
# ver: 0a
...
def main():
    try:
        ...
        raise ValueError('[1]', os.path.join(os.path.dirname(__file__), '..'), '[2]', os.path.dirname(os.path.realpath(__file__)), '[3]', os.path.abspath(os.path.dirname(__file__)))
